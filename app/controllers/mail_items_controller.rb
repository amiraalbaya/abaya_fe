class MailItemsController < ApplicationController
  ...
  private
    ...
    def mail_item_params
      params.require(:mail_item).permit(:id, :date_arrived_pittsburgh, :date_arrived_qatar, :date_delivered, :sender_string, :description, :comment, :shipping_weight, :discard, :user_id)
    end
end
